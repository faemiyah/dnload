...
def determine_platform():
    ...
    if re.search(r'(arch|manjaro|antergos|parabola)', osversion + osarch, re.I):
        osname = "Arch"
...
g_platform_variables = {
    ...
    "interp": {"FreeBSD": "\"/libexec/ld-elf.so.1\"", "Linux-arm32l": "\"/lib/ld-linux.so.3\"", "Linux-arm32lhf": "\"/lib/ld-linux-armhf.so.3\"", "Linux-ia32": "\"/lib/ld-linux.so.2\"", "Linux-amd64": "\"/lib64/ld-linux-x86-64.so.2\""},
    "interp-cross": {"FreeBSD-ia32": "\"/libexec/ld-elf32.so.1\""},
    "march": {"amd64": "core2", "armv6l": "armv6t2", "armv7l": "armv7", "armv7lhf": "armv7", "ia32": "pentium4"},
