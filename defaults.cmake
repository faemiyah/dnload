...
function(check_linker_flag flag)
  ...
  if(1 LESS ${ARGC})
    if("DEBUG" STREQUAL "${ARGV1}")
      string(STRIP "${CMAKE_EXE_LINKER_FLAGS_DEBUG} ${flag}" CMAKE_EXE_LINKER_FLAGS_DEBUG_NEW)
      set(CMAKE_EXE_LINKER_FLAGS_DEBUG "${CMAKE_EXE_LINKER_FLAGS_DEBUG_NEW}" PARENT_SCOPE)
    elseif("RELEASE" STREQUAL "${ARGV1}")
      string(STRIP "${CMAKE_EXE_LINKER_FLAGS_RELEASE} ${flag}" CMAKE_EXE_LINKER_FLAGS_RELEASE_NEW)
      set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS_RELEASE_NEW}" PARENT_SCOPE)
    else()
      message(SEND_ERROR "unknown build type ${ARGV1}")
    endif()
  else()
    string(STRIP "${CMAKE_EXE_LINKER_FLAGS} ${flag}" CMAKE_EXE_LINKER_FLAGS_NEW)
    set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS_NEW}" PARENT_SCOPE)
  endif()
...
function(find_freetype)
  if(${MSVC})
    ...
    set(FREETYPE_LIBRARY_RELEASE "freetype255MT.lib" PARENT_SCOPE)
  else()
    set(lib_mode SHARED)
    if(1 LESS ${ARGC})
      set(lib_mode "${ARGV1}")
    ...
    set(FREETYPE_LIBRARY_DEBUG ${FREETYPE_LIBRARIES} PARENT_SCOPE)
    set(FREETYPE_LIBRARY_RELEASE ${FREETYPE_LIBRARIES} PARENT_SCOPE)
  endif()
endfunction()
...
function(find_glew)
  if(${MSVC})
    ...
    set(GLEW_LIBRARY_RELEASE "glew32s.lib" PARENT_SCOPE)
  else()
    set(lib_mode SHARED)
    if(1 LESS ${ARGC})
      if("STATIC" STREQUAL "${ARGV1}")
    ...
    set(GLEW_LIBRARY_DEBUG ${GLEW_LIBRARIES} PARENT_SCOPE)
    set(GLEW_LIBRARY_RELEASE ${GLEW_LIBRARIES} PARENT_SCOPE)
  endif()
endfunction()
...
function(find_jpeg)
  if(${MSVC})
    ...
    set(JPEG_LIBRARY_RELEASE "jpeg.lib" PARENT_SCOPE)
  else()
    set(lib_mode SHARED)
    if(1 LESS ${ARGC})
      set(lib_mode "${ARGV1}")
    ...
    if(JPEG_FOUND)
      ...
      set(JPEG_LIBRARY_DEBUG ${JPEG_LIBRARIES} PARENT_SCOPE)
      set(JPEG_LIBRARY_RELEASE ${JPEG_LIBRARIES} PARENT_SCOPE)
    elseif(ARGV0)
...
function(find_ogg)
  if(${MSVC})
    ...
    set(OGG_LIBRARY_RELEASE "Release/libogg_static" PARENT_SCOPE)
  else()
    set(lib_mode SHARED)
    if(1 LESS ${ARGC})
      set(lib_mode "${ARGV1}")
    ...
    set(OGG_LIBRARY_DEBUG ${OGG_LIBRARIES} PARENT_SCOPE)
    set(OGG_LIBRARY_RELEASE ${OGG_LIBRARIES} PARENT_SCOPE)
  endif()
endfunction()
...
function(find_openal)
  if(${MSVC})
    ...
    set(OPENAL_LIBRARY_RELEASE "Release/OpenAL32" PARENT_SCOPE)
  else()
    set(lib_mode SHARED)
    if(1 LESS ${ARGC})
      set(lib_mode "${ARGV1}")
    ...
    set(OPENAL_LIBRARY_DEBUG ${OPENAL_LIBRARY} PARENT_SCOPE)
    set(OPENAL_LIBRARY_RELEASE ${OPENAL_LIBRARY} PARENT_SCOPE)
  endif()
endfunction()
...
function(find_png)
  if(${MSVC})
    ...
    set(PNG_LIBRARY_RELEASE "Release Library/libpng16" "Release Library/zlib" PARENT_SCOPE)
  else()
    set(lib_mode SHARED)
    if(1 LESS ${ARGC})
      set(lib_mode "${ARGV1}")
    ...
    if(PNG_FOUND)
      ...
      set(PNG_LIBRARY_DEBUG ${PNG_LIBRARIES} PARENT_SCOPE)
      set(PNG_LIBRARY_RELEASE ${PNG_LIBRARIES} PARENT_SCOPE)
    elseif(ARGV0)
      message(SEND_ERROR "libpng required but not found")
    endif()
  endif()
...
function(find_sdl)
  if(${MSVC})
    ...
    set(SDL_LIBRARY_RELEASE "SDL" "SDLmain" PARENT_SCOPE)
  else()
    set(lib_mode SHARED)
    if(1 LESS ${ARGC})
      set(lib_mode "${ARGV1}")
    ...
    set(SDL_LIBRARY_DEBUG "${SDL_LIBRARY}" PARENT_SCOPE)
    set(SDL_LIBRARY_RELEASE "${SDL_LIBRARY}" PARENT_SCOPE)
  endif()
endfunction()
...
function(find_vorbis)
  if(${MSVC})
    ...
    set(VORBIS_LIBRARY_RELEASE "Release/libvorbis_static" PARENT_SCOPE)
  else()
    set(lib_mode SHARED)
    if(1 LESS ${ARGC})
      set(lib_mode "${ARGV1}")
    ...
    set(VORBIS_LIBRARY_DEBUG ${VORBIS_LIBRARIES} PARENT_SCOPE)
    set(VORBIS_LIBRARY_RELEASE ${VORBIS_LIBRARIES} PARENT_SCOPE)
  endif()
endfunction()
